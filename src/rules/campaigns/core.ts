 ...
 * (40), attributeBaseline (5, the midpoint of the standard 1-9 scale),
 * attributeMin/Max (1/9, the full standard scale), and valueBias (1.0 — no
 * Value Biases are registered) are NOT yet structured Core registry
 * fields — sourced from "AEC — Core Campaign.md" §3 prose, the same gap
 * noted on Crownshard Realms.
 *
 ...
 * Campaign.md doesn't set one. Director sets it to 5 here — matching Core's
 * Attribute baseline rather than reusing Crownshard Realms' narrower
 * tactical-setting value of 4 — as a placeholder pending a real decision
 * recorded in Core.
 */
